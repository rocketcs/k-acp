...

{
  ...
  printf '%s\n' 'DELETE FROM agent_skill_packages WHERE skill_package_id=2079122200000000202;'
  ...
  printf '%s\n' 'DELETE FROM skill_file WHERE skill_id=2079122200000000202;'
  printf '%s\n' 'DELETE FROM skill_package WHERE id=2079122200000000202;'
